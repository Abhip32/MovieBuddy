...
const ListMovie = ({ media_type }: Props) => {
    ...
    return (
        <div className='pt-20 pb-12 bg-gradient-to-b from-deep-purple to-black '>
            <section className='top-rated py-6 '>
                <Wrapper>
                    <h2 className='text-bold text-white capitalize py-1 text-2xl relative'>
                        {media_type === 'movie' ? "Explore Movies" : "Explore TV Series" }
                    </h2>
